import { ACTION, ORDER, TYPE_CONTENT } from '../../utils/constants/enums'
import { ContentItem, Header, Item, Line } from '../../utils/constants/types';
...
function call_actions_callbacks(actions: Map<ACTION, Function>, action: ACTION) {
    let callback = actions.get(action)
...
function headerContentPart(header: Header) {
    return (
        <th className={`w-${header.width}%  py-4 px-4 font-medium text-black dark:text-white `}>
            {header.title}
        </th>
    ...
    if (contentItem.type?.includes(TYPE_CONTENT.BADGE)) {
        ...
        return (
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                {contentItem.type?.includes(TYPE_CONTENT.IMAGE) && imageRender(contentItem.content)}
...
function CustomTable({ headers, lines, actions }: Props) {



    return (
        <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            <div className="py-6 px-4 "><h4 className="text-xl font-semibold text-black dark:text-white">Top Products</h4></div>
                            ...
                            lines.map((items) => {
                                return (<tr>
                                    ...
                                    {items.map((item) => {
                                        ...
                                        //         return (itemContentPart(contentItem))
                                        //     })}
                                        // </td>)
                                    })}
