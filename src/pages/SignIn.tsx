...
export default function SignInPage() {
  ...
  return (
    <>
      <div className="rounded-sm sm:h-screen border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mb-6">
                  ...
                  <span className="text-danger block mb-2">
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value={isPending ? 'Loading...' : 'Sign In'}
                    disabled={isPending}
